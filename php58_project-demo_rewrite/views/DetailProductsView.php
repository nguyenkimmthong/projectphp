		...
		<div class="watch-availabel">
			...
			<div class="total">
				...
				<div class="count-total">
					...
					<a style="font-weight: 600;text-decoration: none;" href="index.php?controller=cart&action=create&id=<?php echo $record->id; ?>"><button id="add-bag">ADD TO BAG</button></a>
				</div>
				<div class="bought"><a href="index.php?controller=cart&action=checkout"><button>BUY IT NOW</button></a></div>
			</div>
		</div>
	</div>
</div>
