...
<div class="content">
    ...
    <div class="mySlides1">
      <div class="row2">
        ...
        <div class="column2" style="position: relative;">
          ...
          <!-- /wishlist -->
          <a href="products/detail/<?php echo $rows->id; ?>/<?php echo Unicode::removeUnicode($rows->name); ?>"><img src="assets/upload/products/<?php echo $rows->photo; ?>" title="<?php echo $rows->name; ?>" alt="<?php echo $rows->name; ?>" style="width: 100%" /></a>
          <div class="product-title">
            <a href="products/detail/<?php echo $rows->id; ?>/<?php echo Unicode::removeUnicode($rows->name); ?>"><?php echo $rows->name; ?></a>
          </div>
  ...
  <div style="padding-top: 25px; "
    ...
    <div class="gallery-cell">
      ...
      <div class="col-lg-3" style="position: relative;">
        ...
        <div class="wishlist"><a href="index.php?controller=wishlist&action=create&id=<?php echo $rows->id; ?>" style="color:white"><span class="fa fa-heart"></span></a></div>
        <!-- /wishlist -->
        <a href="products/detail/<?php echo $rows->id; ?>/<?php echo Unicode::removeUnicode($rows->name); ?>"><img src="assets/upload/products/<?php echo $rows->photo; ?>" title="<?php echo $rows->name; ?>" alt="<?php echo $rows->name; ?>" width="100%" /></a>
  ...
  <div class="image-list">
    ...
    <div class="fax">
      <div style="margin-top: 610px;" class="row5">
        <div class="col-lg-3">
          <div class="flip-box">
