...
<html lang="en">
	<head>
		<!--dat duong dan root de load file theo duong dan root nay-->
		<base href="http://skincaressshopss.byethost7.com/">
		<!-- <base href="http://localhost/php58_project-demo_rewrite/"> -->
		<!--/dat duong dan-->
		<meta charset="UTF-8">
	...
	<body>
		...
		<div style="margin-top: 4333px;" class="footer">
