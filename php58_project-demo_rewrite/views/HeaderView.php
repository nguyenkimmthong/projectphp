  ...
  <div class="icon-bar">
    ...
    <div class="menu">
      <div class="covermenu">
        ...
        <div class="dropdown">
          <button class="dropbtn"><a href="cart">Giỏ hàng</a></button>
          <div class="dropdown-content">
        ...
        <div class="dropdown">
          <button class="dropbtn"><a href="news">Tin tức</a></button>
          <div class="dropdown-content">
        ...
        <div class="dropdown">
          <button class="dropbtn"><a href="contact">Liên hệ</a></button>
          <div class="dropdown-content">
        ...
        <div class="dropdown">
          <button class="dropbtn"><a href="wishlist">Yêu thích</a></button>
          <div class="dropdown-content">
            <!-- <a href="#">Link 1</a>
            <a href="#">Link 2</a>
            <a href="#">Link 3</a> -->
